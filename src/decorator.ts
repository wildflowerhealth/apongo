...
export function Apongo(lookup: IApongoLookup, compose?: string[]): PropertyDecorator;
export function Apongo(lookup: IApongoLookup, compose: string[] = [], expr?: string): MethodDecorator {
